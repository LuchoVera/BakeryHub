...
public class TenantManagementService : ITenantManagementService
{
    ...
    public async Task<TenantThemeDto> GetThemeForAdminAsync(Guid adminUserId)
    {
        ...
        var themeEntity = await _context.TenantThemes
            .AsNoTracking()
            .FirstOrDefaultAsync(t => t.TenantId == adminUser.TenantId.Value);
    ...
    public async Task<bool> UpdateThemeForAdminAsync(Guid adminUserId, TenantThemeDto themeDto)
    {
        ...
        if (themeEntity == null)
        {
            ...
            await _context.TenantThemes.AddAsync(themeEntity);
        }
    ...
    public async Task<bool> ResetPublicThemeAsync(Guid adminUserId)
    {
        ...
        var themeEntity = await _context.TenantThemes.FirstOrDefaultAsync(t => t.TenantId == adminUser.TenantId.Value);
        var defaultSettings = GetDefaultThemeSettings();
